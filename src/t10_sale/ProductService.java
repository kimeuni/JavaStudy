...
public class ProductService {
	...
	private void productDelete() {
		...
		if(vo.getpName() == null) System.out.println("==> 삭제할 상품이 없습니다.");
		else {
			res = dao.setProductDelet(vo.getIdx());	//pName상품의 상품고유번호를 읽어와라
			if(res == 0) System.out.println("상품 삭제 실패");
			else System.out.println(pName + "상품이 삭제 되었습니다.");
		}
	}
	...
	private void productList() {
		...
		System.out.println("----------------------------------");
		System.out.println("\t총 상품검수 : " + vos.size() + "건");
		System.out.println("==================================");
	...
	private void productInput() {
		while(true) {
			...
			if(vo.getpName() != null) System.out.println("==> 동일한 상품이 존재합니다.");
				...
				else System.out.println("==> 상품이 등록되었습니다.");
