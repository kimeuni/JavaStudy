...
public class T04_cardLayout extends JFrame {
	private JButton btn;
	private JPanel pn1, pn2, pn3;
	
	public T04_cardLayout() {
		super("CardLayout 연습");
		setSize(250,400);
...
//		add(pn1);
	...
	private JPanel getPn1() {
		pn1 = new JPanel();
//		pn1.setBackground(Color.RED);
		pn1.setBackground(new Color(255,179,159));	// Coler(r,g,b)
		return pn1;
	}
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				T04_cardLayout t04 = new T04_cardLayout();
				t04.setVisible(true);
			}
		});
	}
